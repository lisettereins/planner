...
export default function NewEventCard({ date: initialDate }: { date: string }) {
  ...
  return (
    <form
      ...
      className="relative w-[280px] min-h-[360px] rounded-[32px] bg-white/20 shadow-[0px_4px_27px_-1px_rgba(0,0,0,0.2)] backdrop-blur-[2px] p-7 overflow-hidden"
    >
      <input
        type="text"
        value={title}
